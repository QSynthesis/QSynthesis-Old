...
public:
    ...
    inline void setType(EventType newType) {
        fType = newType;
    }
    ...
    inline void setTick(qint32 tick) {
        fTick = tick;
    }
    ...
    inline void setTrack(int trackNumber) {
    ...
    inline void setVoice(int voice) {
        fVoice = voice;
    }
    ...
    inline bool isNoteEvent() {
        return ((fType == NoteOn) || (fType == NoteOff));
    }
...
public:
    ...
    inline void setFileFormat(int fileFormat) {
        fFileFormat = fileFormat;
    }
    inline int fileFormat() {
        return fFileFormat;
    }

    inline bool sortDisabled() {
        return disableSort;
    }
    inline void setSortDisabled(bool disabled) {
    ...
    inline void setDivisionType(DivisionType type) {
        fDivType = type;
    }
    inline DivisionType divisionType() {
        return fDivType;
    }
    ...
    inline QList<QMidiEvent *> events() {
        return QList<QMidiEvent *>(fEvents);
    }
