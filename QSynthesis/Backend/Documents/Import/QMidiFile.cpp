...
QMidiEvent *QMidiFile::createNoteOffEvent(int track, qint32 tick, int voice, int note,
                                          int velocity) {
    QMidiEvent *e = new QMidiEvent();
...
QMidiEvent *QMidiFile::createNoteOnEvent(int track, qint32 tick, int voice, int note,
                                         int velocity) {
    QMidiEvent *e = new QMidiEvent();
...
bool QMidiFile::load(const QString &filename) {
    QFile in(filename);
...
bool QMidiFile::save(const QString &filename) {
    QFile out(filename);
