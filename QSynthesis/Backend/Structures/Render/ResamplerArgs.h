...
public:
    ...
    QVector<int> pitchCurves() const;
    void setPitchCurves(QVector<int> pitches);

    double realLength() const;
    void setRealLength(double realLength);

    QGenonSettings genonSettings() const;
    void setGenonSettings(const QGenonSettings &genonSettings, bool useFileName = true);
