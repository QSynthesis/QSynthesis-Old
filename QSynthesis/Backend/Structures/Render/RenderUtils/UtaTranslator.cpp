...
QStringList UtaTranslator::convertEnvelopeFromVector(const QVector<QControlPoint> &tpoints,
...
QVector<QControlPoint> UtaTranslator::defaultPitch(const int &prevNoteNum, const QString &prevLyric,
